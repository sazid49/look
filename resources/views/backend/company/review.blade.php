...
@section('content')
    ...
    <x-forms.patch :action="route('admin.company.update_review', $company)" enctype="multipart/form-data" class="custom-validation" novalidate>
                                    ...
                                    <div class="col-md-3">
                                        <div class="row">
                                            <div class="form-check col-md-6">
                                                <input class="form-check-input" type="radio" name="show_review" id="show_rating_yes" value="1" {{ old('show_review', $company->companytabs->show_review ?? '') == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="show_rating_yes">
                                                    {{ __('labels.general.yes') }}
                                                </label>
                                            </div>
                                            <div class="form-check col-md-6 ">
                                                <input class="form-check-input" type="radio" name="show_review" id="show_rating_no" value="0" {{ old('show_review', $company->companytabs->show_review ?? '') == '0' || old('show_review', $company->companytabs->show_review ?? '') == '' ? 'checked' : '' }}>
