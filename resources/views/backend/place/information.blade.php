...
@section('content')
    ...
    <!-- end page title -->
    <x-forms.patch :action="route('admin.places.update_information', $place)" enctype="multipart/form-data" class="custom-validation" novalidate>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select id="category_id" name="category_id"
                                                ...
                                                @foreach ($category as $select)
                                                    <option value="{{ $select->id_cat_place }}"
                                                        {{ old('category_id', $place->category_id) == $select['id_cat_place'] ? 'selected' : '' }}>
                                                        <?php echo "{$select->id_cat_place} - {$select->value_cat_place}"; ?>
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            @if (!empty($place->image_logo))
                                                @if (Storage::disk('public')->exists($place->image_logo))
                                                    <img class="personal_logo" alt="no data"
                                                        src="{{ url('storage/' . $place->image_logo) }}">
                                                @endif
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="firstname" name="firstname" class="form-control"
                                                value="{{ old('firstname', $place->firstname) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="lastname" name="lastname" class="form-control"
                                                value="{{ old('lastname', $place->lastname) }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" id="postcode" name="postcode"
                                                class="form-control"value="{{ old('postcode', $place->postcode) }}">
                                        </div>
                                    </div>
                                    <!-- City / Ort -->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="email" id="email" name="email" class="form-control"
                                                value="{{ old('email', $place->email) }}" required>
                                        </div>
                                    </div>
                                    <!-- Phone 1 -->
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="phone_1" name="phone_1" class="form-control"
                                                value="{{ old('phone_1', $place->phone_1) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="phone_2" name="phone_2" class="form-control"
                                                value="{{ old('phone_2', $place->phone_2) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="phone_3" name="phone_3" class="form-control"
                                                value="{{ old('phone_3', $place->phone_3) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                            ...
                            <div class="card card-body pb-0">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="website" class="form-control"
                                                placeholder="{{ __('labels.place.website') }}"value="{{ old('website', $place->website) }}" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="facebook" class="form-control"
                                                ...
                                                value="{{ old('facebook', $place->facebook ?? '') }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="twitter" class="form-control"
                                                ...
                                                value="{{ old('twitter', $place->twitter ?? '') }}" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="tab-content p-3 text-muted">
                                                <div class="tab-pane active" id="listing_text_de" role="tabpanel">
                                                    <textarea id="description_de" name="description_de">{{ old('description_de', $place->description_de) }}</textarea>
                                                </div>
                                                <div class="tab-pane" id="listing_text_fr" role="tabpanel">
                                                    <textarea id="description_fr" name="description_fr">{{ old('description_fr', $place->description_fr) }}</textarea>
                                                </div>
                                                <div class="tab-pane" id="listing_text_en" role="tabpanel">
                                                    <textarea id="description_en" name="description_en">{{ old('description_en', $place->description_en) }}</textarea>
                                                </div>
                                                <div class="tab-pane" id="listing_text_it" role="tabpanel">
                                                    <textarea id="description_it" name="description_it">{{ old('description_it', $place->description_it) }}</textarea>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xl-12">
                                        <div class="mb-3">
                                            <label for="name"
                                                class="form-label">{{ __('labels.place.notes') }}</label>
                                            <textarea name="notes" id="notes" class="form-control" rows="10">{{ old('notes', $place->notes) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
