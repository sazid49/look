...
@section('title', __('labels.tags.create_field'))
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box1 mb-2 d-sm-flex align-items-center justify-content-between">
                <div class="col-md-6">
                    <h4 class="mb-sm-0 font-size-18">{{ __('labels.tags.create_field') }}</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('labels.tags.create_field') }}</li>
                    </ol>
                </div>
    ...
    <!-- end page title -->
    <x-forms.post :action="route('admin.tags.store')" enctype="multipart/form-data" class="custom-validation outer-repeater1" novalidate>
        {{--  --}}
        <x-backend.card>
            <x-slot name="body">
                <div data-repeater-list="outer-group" class="outer">
                    <div data-repeater-item class="outer">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="name" class="form-label">{{ __('labels.tags.name') }}<span class="error">*</span></label>
                                    <input type="text" name="value" class="form-control" value="{{ old('value') }}"
                                        required />
                                </div>
                                <div class="mb-3">
                                    <label for="image" class="form-label">{{ __('labels.tags.image') }}</label>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    <label for="description" class="form-label">{{ __('labels.tags.description') }}</label>
            ...
            <x-slot name="footer">
                <button class="btn btn-primary float-right" type="submit">{{ __('labels.tags.create_field') }}</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
