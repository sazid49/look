                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <x-utils.link
                            class="nav-link
                            {{
                                !empty($company->companytabs)
                                && $company->companytabs->show_review == 1
                                && $company->active == 1
                                && $company->published == 1
                                && $company->show_tabs ? '' : 'disabled' }}"
                    ...
                    <li class="nav-item">
                        <x-utils.link
                            class="nav-link
                                    {{
                                        !empty($company->companytabs)
                                        && $company->companytabs->show_gallery == 1
                                        && $company->active == 1
                                        && $company->published == 1
                                        && $company->show_tabs == 1 ? '' : 'disabled'
                                    }}"
                            :href="route('frontend.company.gallery', [$company, 'slug' => $company->slug])"
                            :active="activeClass(Route::is('frontend.company.gallery'), 'active')"
                    ...
                    <li class="nav-item">
                        <x-utils.link
                            ...
                            {{
                                !empty($company->companytabs)
                                && $company->companytabs->show_jobs == 1
                                && $company->active == 1
                                && $company->published == 1
                                && $company->show_tabs == 1 ? '' : 'disabled'
                            }}"
                    ...
                    <li class="nav-item">
                        <x-utils.link
                            class="{{
                                "nav-link ".
                                !empty($company->companytabs)
                                && $company->companytabs->show_team == 1
                                && $company->active == 1
                                && $company->published == 1
                                && $company->show_tabs == 1 ? '' : 'disabled'
                            }}"
                    ...
                    <li class="nav-item">
                        <x-utils.link class="nav-link {{
                                !empty($company->companytabs)
                                 && $company->companytabs->show_pricelist == 1
                                 && $company->active == 1
                                 && $company->published == 1
                                 && $company->show_tabs == 1 ? '' : 'disabled' }}"
                                      :href="route('frontend.company.price_list', [$company, 'slug' => $company->slug])"
                                      :active="activeClass(Route::is('frontend.company.price_list'), 'active')"
                    ...
                    <li class="nav-item">
                        <x-utils.link
                            class="nav-link {{
                                !empty($company->companytabs)
                                && $company->companytabs->show_register == 1
                                && $company->active == 1
                                && $company->published == 1 ? '' : 'disabled' }}"
