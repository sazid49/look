...
<!-- end page title -->
<x-forms.patch :action="route('frontend.panel.company.update_interaction', $company)" enctype="multipart/form-data" class="custom-validation" novalidate>
    <x-backend.card>
        <x-slot name="body">
            ...
            <div class="tab-content p-3 text-muted">
                <div class="tab-pane active" id="interraktion" role="tabpanel">
                    <section>
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="form-check col-md-6">
                                            <input class="form-check-input" type="radio" name="show_interraction" id="show_interraction_yes" value="1" {{ old('show_interraction', $company->companytabs->show_interraction ?? '') == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="show_interraction_yes">
                                                {{ __('labels.general.yes') }}
                                            </label>
                                        </div>
                                        <div class="form-check col-md-6 ">
                                            <input class="form-check-input" type="radio" name="show_interraction" id="show_interraction_no" value="0" {{ old('show_interraction', $company->companytabs->show_interraction ?? '') == 0 || old('show_interraction', $company->companytabs->show_interraction ?? '') == '' ? 'checked' : '' }}>
