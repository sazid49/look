...
<!-- end page title -->
<x-forms.patch :action="route('frontend.panel.company.gallery.update_gallery', $company)" enctype="multipart/form-data" class="custom-validation" novalidate>
    <x-backend.card>
        <x-slot name="body">
...
<div class="modal fade bs-gallary-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabelJob" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <x-forms.post :action="route('frontend.panel.company.gallery.store',[$company])" enctype="multipart/form-data" class="custom-validation" novalidate>
