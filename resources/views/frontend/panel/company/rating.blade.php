...
<!-- end page title -->
<x-forms.patch :action="route('frontend.panel.company.update_rating', $company)" enctype="multipart/form-data" class="custom-validation" novalidate>
    <x-backend.card>
        <x-slot name="body">
            ...
            <div class="tab-content p-3 text-muted">                
                <div class="tab-pane active" id="bewertung" role="tabpanel">
                    <section>
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="form-check col-md-6">
                                            <input class="form-check-input" type="radio" name="show_rating" id="show_rating_yes" value="1" {{ old('show_rating', $company->companytabs->show_rating ?? '') == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="show_rating_yes">
                                                {{ __('labels.general.yes') }}
                                            </label>
                                        </div>
                                        <div class="form-check col-md-6 ">
                                            <input class="form-check-input" type="radio" name="show_rating" id="show_rating_no" value="0" {{ old('show_rating', $company->companytabs->show_rating ?? '') == '0' || old('show_rating', $company->companytabs->show_rating ?? '') == '' ? 'checked' : '' }}>
