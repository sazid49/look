<x-forms.patch :action="route('frontend.panel.company.job_application.update', [$company, $job])" enctype="multipart/form-data" class="custom-validation" novalidate>
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group mb-3 col-md-6">
                ...
                <input type="date" name="job_start_date" class="form-control" value="{{ $job->start_date }}">
            </div>
            <div class="form-group mb-3 col-md-6">
