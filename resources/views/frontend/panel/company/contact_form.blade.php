...
<!-- end page title -->
<x-forms.patch :action="route('frontend.panel.company.update_contact_form', $company)" enctype="multipart/form-data" class="custom-validation" novalidate>
    <x-backend.card>
        <x-slot name="body">
                                ...
                                <div class="col-md-2">
                                    <div class="row">
                                        <div class="form-check col-md-6">
                                            <input class="form-check-input" type="radio" name="show_contactform" id="show_contactform_yes" value="1" {{ old('show_contactform', $company->companytabs->show_contactform ?? '') == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="show_contactform_yes">
                                                {{ __('labels.general.yes') }}
                                            </label>
                                        </div>
                                        <div class="form-check col-md-6 ">
                                            <input class="form-check-input" type="radio" name="show_contactform" id="show_contactform_no" value="0" {{ old('show_contactform', $company->companytabs->show_contactform ?? '') == 0 || old('show_contactform', $company->companytabs->show_contactform ?? '') == '' ? 'checked' : '' }}>
