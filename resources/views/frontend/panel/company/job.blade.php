...
<!-- end page title -->
<x-forms.patch :action="route('frontend.panel.company.update_finance_publish', $company)" enctype="multipart/form-data" class="custom-validation" novalidate>
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="form-check col-md-6">
                                            <input class="form-check-input" type="radio" name="show_jobs" id="show_jobs_yes" value="1" {{ old('show_jobs', $company->companytabs->show_jobs ?? '') == '1' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="show_jobs_yes">
                                                {{ __('labels.general.yes') }}
                                            </label>
                                        </div>
                                        <div class="form-check col-md-6 ">
                                            <input class="form-check-input" type="radio" name="show_jobs" id="show_jobs_no" value="0" {{ old('show_jobs', $company->companytabs->show_jobs ?? '') == '0' || old('show_jobs', $company->companytabs->show_jobs ?? '') == '' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="show_jobs_no">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm btn-icon ml-auto1 waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-popup-modal-lg" data-url="{{route('frontend.panel.company.job_application.edit',[$company,$job])}}" onclick='show_modal(this)'>
                                                        <i class="fas fa-pencil-alt"></i>
                                                        {{__('labels.general.edit')}}
                                                    </button>
                                                    <button type="button" class="btn btn-info btn-sm btn-icon ml-auto1 waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-popup-modal-lg" data-url="{{route('frontend.panel.company.job_application.show',[$company,$job])}}" onclick='show_modal(this)'>
                                                        <i class="fas fa-search"></i>
                                                        {{__('labels.general.show')}}
                                                    </button>
                                                    <a data-method="delete" data-trans-button-cancel="Cancel" data-trans-button-confirm="Delete" data-trans-title="Warning" data-trans-text="Are you sure you want to delete this item?" href="{{ route('frontend.panel.company.job_application.destroy',[$company,$job]) }}" class="btn btn-danger btn-sm btn-icon ml-auto1 waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="@lang('buttons.general.crud.delete')">
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <x-forms.post :action="route('frontend.panel.company.job_application.store',[$company])" enctype="multipart/form-data" class="custom-validation" novalidate>
