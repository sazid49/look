...
class Xcrud
{
    ...
    protected function file_link($field, $primary_val, $thumb = false, $crop = false, $filename = false)
    {
        ...
        $params = array('xcrud' => array(
                ...
                'key' => $this->key,
                'task' => 'file',
                'rand' => base_convert(crc32($this->instance_name . ($filename ? $filename : rand())), 10, 36)));
        if ($thumb !== false)
        {
    ...
    public static function load_css()
    {
        ...
        // Because its already from the website, dont need it from xcrud
        // Arsim Murtezi, 21.01.2023
    ...
    public static function load_js()
    {
        ...
        */
        ...
        // Because the Website has it already
        // Arsim Murtezi, 21.01.2023
        /*
        if (Xcrud_config::$load_bootstrap4)
        {
        ...
        */
        ...
        if (Xcrud_config::$load_googlemap)
            ...
            // Because we have it already on the website
            // Arsim Murtezi, 21.01.2023
            ...
            // Uncomment, because we use jquery from the site (newer version) and xcrud.js loaded before jquery (on the footer)
            // So we are implementing it on the app.blade.php (ressources -> views -> layout)
            // Arsim Murtezi, 21.01.2023
