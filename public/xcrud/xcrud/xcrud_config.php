...
class Xcrud_config
{
    ...
    // theme and language
    public static $theme = 'bootstrap4'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
    public static $language = 'de'; // sets default localization
    ...
    // scripts
    // Bootstrap and jquery were disabled on xcrud.php to avoid duplicate scripts
    ...
    public static $load_tabulator = false;
    ...
    public static $limit_list = array('25', '50', '100'); // default limits list, all ist auch möglich
