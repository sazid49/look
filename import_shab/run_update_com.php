...
use lookon\lib\import\CompanyUpdateService;
...
require_once('lib/CompanyModel.php');
require_once('lib/CompanyStore.php');

require_once('services/CompanyUpdateService.php');
...
$CompanyUpdateService = new CompanyUpdateService( $db_object );
