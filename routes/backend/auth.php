...
Route::group([
	...
	Route::group([
		...
		Route::group([
			...
			Route::group(['prefix' => '{user}'], function () {
				...
				Route::post('/id-approve', [UserController::class, 'IdApprove'])->name('id_approve');
			});
    ...
    Route::patch('profile/update', [AccountController::class, 'update'])->name('update');
    Route::patch('profile/updatePassword', [AccountController::class, 'updatePassword'])->name('updatePassword');
});
