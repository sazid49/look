...
Route::group(['as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::get('company/register', [RegisterController::class, 'showComapanyRegistrationForm'])->name('company.register');
        Route::post('company/register', [RegisterController::class, 'ComapanyRegistration']);
