...
<head>
  ...
  $currentPage = 'Tearms and Condition'; ?>
</head>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="terms-condition">
                  <h4 class="mt-0"> 1. Einführung</h4>
                  <p>
                    Sie werden nachfolgend in Kenntnis gesetzt, für welche Zwecke und Ziele wir Ihre Daten in Zusammenhang mit Ihrer Nutzung unserer Dienste verwenden, bearbeiten sowie nutzen und an wen diese Daten eventuell weitergereicht werden dürfen. Des Weiteren werden Sie hiermit über die Rechtsgrundlage der Bearbeitung Ihrer Daten (sofern dies für nötig befunden wird) und über die Dauer deren Bearbeitung informiert. Der Geltungsbereich dieser Datenschutzerklärung erstreckt sich über all Ihre Daten, welche wir erhalten haben bzw. künftig erhalten werden. Lookon behält sich vor, die Datenschutzerklärung mit der Zeit anzupassen, sofern dies notwendig ist. Die aktuelle auf www.lookon.ch publizierte Version gilt jeweils.</p>
                  <p>

                    Auf bestimmbare oder bestimmte Personen beziehende Informationen gelten als Personendaten und werden nachfolgend als "<b>Personendaten</b>" beschrieben. Angaben wie Name, Adressanschrift, Email-Adresse sowie Telefonnummer gelten als Personendaten, wobei auch Geräte-ID's sowie IP-Adressen ebenfalls als solche klassifiziert werden. Anonyme Informationen werden dem Sammelbegriff Daten untergeordnet. Das Speichern, Archivieren, Erheben, Nutzen, Löschen sowie Bekanntgeben von Daten wird nachfolgend als "<b>Bearbeiten</b>" definiert.</p>
                  <p>

                    Bitte stellen Sie sicher, dass Sie uns nur Personendaten anderer Personen übermitteln, die diese vorliegende Datenschutzerklärung in Kenntnis genommen haben. Des Weiteren müssen Sie gemäss geltendem Datenschutzrecht auch dazu berechtigt sein.</p>
                  <h4> 2. Verantwortliche</h4>
                  <p>
                    Für die Bearbeitung der Daten gemäss der vorliegenden Datenschutzerklärung ist Lookon in Düdingen, Schweiz, berechtigt. Anfragen hinsichtlich Datenschutz können jederzeit elektronisch an contact@lookon.ch übermittelt werden. </p>
                  <h4>

                    3. Kategorien der bearbeiteten Daten</h4>
                  <p>
                    Durch den Kontakt mit Lookon sowie die Nutzung unserer Dienste (wie beispielsweise der Vertragsabschluss, der Kontakt mit unserem Personal, der Besuch von www.lookon.ch, Registrierung sowie Anmeldung ins Userkonto oder die Nutzung unserer Mobile App) werden gewisse Daten erhoben, welche wir prinzipiell direkt von Ihnen erhalten. Es ist jedoch nicht ausgeschlossen, dass wir auch von anderen Personen Daten erhalten wie beispielsweise durch Ihren Arbeitgeber, der uns Ihre Angaben zur Verfügung stellt oder durch eine Firma, mit der Sie vertraglich gebunden sind. Auch Bewertungen sowie Kommentare anderer Personen zu Ihnen wird als indirekte Weitergabe von Daten angesehen.</p>
                  <p>

                    Folgende Personendaten könnten von uns bearbeitet werden:</p>
                  <ul>
                    <li>Bei der Registrierung für unsere Dienste an uns bekannt gegebene Daten wie bspw. Name, Adressdaten, Geburtsdatum, Zivilstand, Geschlecht, Beruf, Sprache, Foto, Zahlungsangaben, Mitarbeitende sowie Angehörige usw.</li>
                    <li>Daten aus bereits abgeschlossenen Verträgen und Offerten wie bspw. Vertragsart sowie deren Datum, Laufzeit, Inhalt, Parteien, Produkt, Zahlungsangaben, Ansprechpartner, Kundenmeinung, Kündigungen, Rechnungsadressen usw.</li>
                    <li>Ausgetauschte Daten durch den Kontakt mit Lookon wie bspw. Briefkorrespondenzen, Kontakt per Email, Telefon, SMS/MMS, Instant Messaging usw.</li>
                    <li>Daten, die uns von Geschäftspartnern vorliegen wie bspw. firmeninterne Kontaktpersonen, Bonitätsdaten, Adressdaten usw.
                      ...
                      Daten, die uns von Ihnen oder Dritten durch die Teilnahme an Umfragen, Gewinnspielen o.ä. zur Verfügung gestellt werden.</li>
                    <li>Aus öffentlichen Quellen stammende Daten wie bspw. Handelsregisterinformationen.</li>
                    <li>Durch die Nutzung unserer Dienste von erfassten sowie nicht erfassten Nutzern bekanntgegebene Daten wie bspw. Geräte-ID, MAC-Adresse sowie IP-Adresse des verwendeten Geräts, eingetippte Suchwörter und aufgerufene Webseiten von Nutzern, Internet Service Provider, Klicks, Cookies, Dauer und Zeitpunkt der Besuche, verwendete Gerätetyp, Betriebssystem und Browser, Bewertungen, Reservationen, übertragene Datenmenge usw. Lookon ist das Zusammenführen der Daten aus verschiedenen Diensten vorbehalten.</li>
                  </ul>
                  <p>
                    Nicht in jedem Fall handelt es sich bei den oben genannten Angaben um Personendaten. Die durch die Nutzung unserer Dienste ohne Registrierung erhobenen Daten können wir keiner bestimmten namentlichen Person zuordnen. Dies ist nur durch Kombinieren mit Daten weiterer Dienste in seltenen Fällen möglich. </p>
                  <p>
                    Zur Aufnahme einer Vertragsbeziehung und die entsprechende Einhaltung der verbundenen vereinbarten Pflichten, welche rechtlich vorgeschrieben sind, werden Sie uns bestimmte Personendaten zur Verfügung stellen müssen, damit Sie unsere Dienste optimal nutzen können. Ansonsten wird es uns nicht möglich sein, eine Vertragsbeziehung aufzubauen, auszuführen oder bestimmte Dienste erbringen zu können. </p>
                  <p>
                    Grundsätzlich ist uns der Abschluss oder die Ausführung des Vertrags oder die Ausführung von bestimmten Diensten ohne diese Personendaten nicht möglich. Ferner wird auch der Zugriff auf unsere Dienste protokolliert werden müssen, wobei auch das Erheben von digitalen Daten wie das Geräte-ID oder die IP-Adresse damit verbunden wäre. Aufgrund dessen, dass diese Daten bei der Benutzung automatisch erhoben werden, kann dies für bestimmte Nutzer nicht abgestellt werden. Folglich sollten Sie unsere Dienste nicht nutzen, falls Sie mit der Erhebung dieser Daten nicht einverstanden sind.</p>
                  <h4>
                    4. Bearbeitungszwecke und Rechtsgrundlagen
                  </h4>
                  <p>
                    Für folgende Zwecke wird das Bearbeiten von Personendaten notwendig sein, sofern dies nach geltendem Recht erlaubt ist: </p>
                  <ul>
                    <li>Marketing, Promotionen sowie Werbung, Kundensupport, Austausch und Kommunikation mit Kunden, Bearbeitung, Entwicklung, sowie Pflege unserer Kundenbeziehungen, Erstellung sowie Bearbeitung von Nutzerkonten, Angebot von angepassten Inhalten und Diensten</li>
                    <li>Entwicklung von neuen Diensten, Optimierung und Sicherstellung unserer Infrastruktur und Diensten, Betrieb und Wartung, Optimierung, Weiterentwicklung sowie Angebot unserer bestehenden Diensten</li>
                    <li>Administration aller Nutzer unserer Dienste, Anmeldedaten, Authentifizierungen sowie Identitätsprüfungen</li>
                    <li>Aufnahme, Abschluss, Einhaltung sowie fachgerechte Abwicklung verschiedener Verträge</li>
                    <li>Geschäftsführung sowie Weiterentwicklung der Firma, unserer Dienste und Aktivitäten, Marktforschung und Qualitätskontrolle, Erstellen von Managementdaten, Berichten und Statistiken aller Art, Erwerb von Gesellschaften und aller Geschäftsbereiche</li>
                    <li>Einhaltung regulatorischer sowie rechtlicher Pflichten und interner Normen, Beschwerden, Beantwortung und Bearbeitung von Amts- sowie Behördenanfragen, Verwaltungs-, Straf- sowie Zivilverfahren, Missbrauchsbekämpfung</li>
                    <li>Schutz unserer vorliegenden Daten, unserer Mitarbeitenden, der Nutzer sowie Dritter, System-, Gebäude und Infrastruktursicherheit, Vermögenswerte und Geschäftsgeheimnisse</li>
                    <li>Bearbeitung, Administration sowie Abgleich von Datenbanken (beinhaltet auch unser Adressdatenverzeichnis und unserer Vertragspartner), Bearbeitung und Veröffentlichung von Verzeichnissen (grundsätzlich digital im Internet oder in seltenen Fällen in gedruckter Form)</li>
                  </ul>
                  <p>
                    Ferner können wir Personendaten auch für anderweitige Zwecke verwalten, sofern wir rechtlich dazu verpflichtet sind oder die Bearbeitung bei der Datenerhebung unmissverständlich erkennbar war respektive wir den Nutzer anderweitig darüber informiert haben. </p>
                  <p>Personendaten werden basierend folgender Rechtsnormen für die oben genannten Zwecke von uns genutzt, sofern solche unter geltendem Datenschutzrecht notwendig sind:</p>
                  <ul>
                    <li>Einhaltung rechtlicher und regulatorischer Verpflichtungen und interner Regeln, Rechtsdurchsetzung, Zivil-, Verwaltungs- und Strafverfahren, Beschwerden, Missbrauchsbekämpfung, Untersuchungen und Beantwortung von Anfragen von Behörden</li>
                    <li>Schutz der Nutzer, unserer Mitarbeitenden und Dritter, unserer Daten, Geheimnisse, Infrastruktur und Vermögenswerte</li>
                    <li>Angebot und Erbringen von Diensten
                      - Kontaktpflege und Kommunikation mit Nutzern und Dritten</li>
                    <li>Vertragserfüllung</li>
                    <li> Erfüllung rechtlicher Verpflichtungen</li>
                    <li>Einwilligung, die uns oder Dritten gegenüber erteilt wurde</li>
                    <li>Berechtigte Interessen von uns und von Dritten, insbesondere: Werbung und Marketing Nachvollziehen von Nutzerverhalten, -vorlieben und -bedürfnissen, Marktstudien</li>
                    <li>Weiterentwicklung und Verbesserung unserer Dienste, Entwicklung neuer Dienste</li>
                    <li>Nutzerverwaltung, Identitätsprüfungen, Log-ins, Authentifizierungen</li>
                    <li>Sinnvolle Unternehmensführung und -entwicklung, erfolgreicher Verkauf oder Kauf von Geschäftsbereichen, Gesellschaften oder Teilen von Gesellschaften und andere gesellschaftsrechtliche Transaktionen</li>
                    <li>Aufrechterhaltung und sichere, effiziente und effektive Organisation des Geschäftsbetriebs, einschliesslich eines sicheren, effizienten und effektiven Betriebs und erfolgreiche Weiterentwicklung der digitalen Dienste und anderer IT-Systeme, Fehlerbehebung</li>
                  </ul>
                  <h4>5. Veröffentlichung und Weitergabe von Daten
                  </h4>
                  <p>
                    Daten können von uns folgenderweise publiziert und weitergereicht werden: </p>
                  <h6>Veröffentlichung von Daten</h6>
                  <p>

                    Die Publikation von bestimmten Daten ist für einige unserer Dienste wie auf www.lookon.ch vorgesehen, wobei diese grundsätzlich auch ausserhalb der Schweiz abrufbar sind. Ferner ist es möglich, dass Daten die über unsere Dienste publiziert werden, auch von Suchmaschinen oder Dritten erfasst sowie indexiert werden und wir dies nicht beeinflussen können. Daher können solche Daten weiterhin überall öffentlich zur Verfügung stehen, auch nachdem diese bei uns schon vernichtet bzw. gelöscht wurden. </p>
                  <h6>Auftragsdatenbearbeiter </h6>
                  <p>Auch Dritte, nachfolgend als "<b>Auftragsdatenbearbeiter</b>", können von uns beauftragt werden, bestimmte Leistungen wie beispielsweise Administration, Versand, Druck zu erbringen, die dafür Daten bearbeiten sowie speichern müssen. Auftragsdatenbearbeiter dürfen in unserem Auftrag auf Personendaten zugreifen sowie bearbeiten. Die Auftragsdatenbearbeiter werden zuvor verpflichtet, Personendaten wie wir zu bearbeiten und dies stets unter Einhaltung des Datenschutzrechts. Bei den Auftragsdatenbearbeiter, die Personendaten bearbeiten und erhalten dürfen, kann es sich auch um Personen ausserhalb der Schweiz wie die USA, Länder aus EWR oder EU handeln. </p>
              ...
              <div class="col-md-3 sticky-top align-self-start top-100px">
                <div class="mt-4 mt-md-0">
                  ...
                  <a href="companyregister.php" class="btn btn-theme mb-5">Register</a>
